...
__( "Error updating settings. %(error)s", "jetpack" ), // _inc/client/state/settings/actions.js:119
__( "Updated settings.", "jetpack" ), // _inc/client/state/settings/actions.js:105
__( "Updating settings…", "jetpack" ), // _inc/client/state/settings/actions.js:87
__( "There are unsaved settings in this tab that will be lost if you leave it. Proceed?", "jetpack" ), // _inc/client/main.jsx:91
__( "There are unsaved settings in this tab that will be lost if you leave it. Proceed?", "jetpack" ), // _inc/client/main.jsx:71
__( "Show falling snow on my blog from Dec 1st until Jan 4th.", "jetpack" ), // _inc/client/appearance/index.jsx:117
__( "Show falling snow in the holiday period.", "jetpack" ), // _inc/client/appearance/index.jsx:104
__( "Holiday Snow", "jetpack" ), // _inc/client/appearance/index.jsx:103
__( "Learn More", "jetpack" ), // _inc/client/appearance/index.jsx:91
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/appearance/index.jsx:61
...
__( "View your earnings", "jetpack" ), // _inc/client/engagement/index.jsx:237
__( "View your {{a}}Email Followers{{/a}}", "jetpack" ), // _inc/client/engagement/index.jsx:218
__( "View {{a}}All Stats{{/a}}", "jetpack" ), // _inc/client/engagement/index.jsx:203
__( "Learn More", "jetpack" ), // _inc/client/engagement/index.jsx:196
__( "Pro", "jetpack" ), // _inc/client/engagement/index.jsx:150
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/engagement/index.jsx:130
...
__( "Manage your Jetpack connection.", "jetpack" ), // _inc/client/general-settings/index.jsx:93
__( "Connection Settings", "jetpack" ), // _inc/client/general-settings/index.jsx:92
__( "Learn More", "jetpack" ), // _inc/client/general-settings/index.jsx:83
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/general-settings/index.jsx:50
...
__( "Learn More", "jetpack" ), // _inc/client/security/index.jsx:124
__( "Pro", "jetpack" ), // _inc/client/security/index.jsx:87
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/security/index.jsx:60
__( "Automatically backup your entire site.", "jetpack" ), // _inc/client/security/index.jsx:55
__( "Site Backups", "jetpack" ), // _inc/client/security/index.jsx:55
__( "State-of-the-art spam defense.", "jetpack" ), // _inc/client/security/index.jsx:54
__( "Automated, comprehensive protection from threats and attacks.", "jetpack" ), // _inc/client/security/index.jsx:51
__( "Security Scanning", "jetpack" ), // _inc/client/security/index.jsx:51
__( "XXXXXXXX", "jetpack" ), // _inc/client/writing/composing.jsx:146
__( "VVVVVVVV", "jetpack" ), // _inc/client/writing/composing.jsx:145
_x( "Composing", "Settings header", "jetpack" ), // _inc/client/writing/composing.jsx:112
__( "Add a phrase", "jetpack" ), // _inc/client/writing/composing.jsx:92
__( "Ignored Phrases", "jetpack" ), // _inc/client/writing/composing.jsx:88
__( "Redundant Phrases", "jetpack" ), // _inc/client/writing/composing.jsx:84
__( "Phrases to Avoid", "jetpack" ), // _inc/client/writing/composing.jsx:83
__( "Passive Voice", "jetpack" ), // _inc/client/writing/composing.jsx:82
__( "Jargon", "jetpack" ), // _inc/client/writing/composing.jsx:81
__( "Hidden Verbs", "jetpack" ), // _inc/client/writing/composing.jsx:80
__( "Double Negatives", "jetpack" ), // _inc/client/writing/composing.jsx:79
__( "Diacritical Marks", "jetpack" ), // _inc/client/writing/composing.jsx:78
__( "Complex Phrases", "jetpack" ), // _inc/client/writing/composing.jsx:77
__( "Clichés", "jetpack" ), // _inc/client/writing/composing.jsx:76
__( "Bias Language", "jetpack" ), // _inc/client/writing/composing.jsx:75
__( "Enable proofreading for the following grammar and style rules: ", "jetpack" ), // _inc/client/writing/composing.jsx:73
__( "English Options", "jetpack" ), // _inc/client/writing/composing.jsx:71
__( "Use automatically detected language to proofread posts and pages", "jetpack" ), // _inc/client/writing/composing.jsx:66
__( "The proofreader supports English, French, German, Portuguese and Spanish.", "jetpack" ), // _inc/client/writing/composing.jsx:58
__( "Automatic Language Detection", "jetpack" ), // _inc/client/writing/composing.jsx:55
__( "A post or page is updated", "jetpack" ), // _inc/client/writing/composing.jsx:52
__( "A post or page is first published", "jetpack" ), // _inc/client/writing/composing.jsx:51
__( "Automatically proofread content when: ", "jetpack" ), // _inc/client/writing/composing.jsx:49
...
__( "Display an ad unit at the top of each page.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:651
__( "News Sitemap: {{a}}%(url)s{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:626
__( "Sitemap: {{a}}%(url)s{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:616
__( "Search engines will find the sitemaps at these locations:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:614
...
__( "{{link}}Configure your %(module_slug)s Settings {{/link}}", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:177
__( "{{link}}Configure your %(module_slug)s Settings {{/link}}", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:148
__( "Real-time offsite backups with automated restores deliver peace-of-mind, so you can focus on writing great content and increasing traffic while we protect every aspect of your investment. Upgrade today.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:141
__( "Let search engines and visitors know that you are serious about your websites integrity by upgrading Jetpack. Our anti-spam tools will eliminate comment spam, protect your SEO, and make it easier for visitors to stay in touch.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:139
__( "This module has no configuration options", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:132
__( "Configure your SEO settings.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:105
__( "Activate this module to use the advanced SEO tools.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:99
__( "Make sure your site is easily found on search engines with SEO tools for your content and social posts.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:91
__( "Configure your Security Scans", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:82
__( "You can see the information about security scanning in the \"At a Glance\" section.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:79
__( "Upgrade Jetpack and our state-of-the-art security scanner will hunt out malicious files and report them immediately so that you're never unaware of what is happening on your website.", "jetpack" ), // _inc/client/components/module-settings/modules-per-tab-page.jsx:73
...
_x( "Save settings", "Button caption", "jetpack" ), // _inc/client/components/settings-card/index.jsx:33
_x( "Saving…", "Button caption", "jetpack" ), // _inc/client/components/settings-card/index.jsx:32
